...
for folder in folders:
    ...
    f_dir = os.path.join(BASE_DIR, folder, "Fittest_Results_MiddleCrossover")
    ...
    for fname in os.listdir(f_dir):
        ...
        if fname.endswith(".txt") and fname != "similarity.txt" and fname != "comparison_with_Thesis_All.txt":

            rel_path = os.path.join(folder, "Fittest_Results_MiddleCrossover", fname)
...
with open("popularity.txt", "w") as out:
